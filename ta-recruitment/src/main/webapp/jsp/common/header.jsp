...
<%
    ...
    // Initials for avatar (Figma: MO portal shows "MO")
    String initials = "??";
    if (currentUser != null) {
        if ("MO".equalsIgnoreCase(role)) initials = "MO";
        else if ("ADMIN".equalsIgnoreCase(role)) initials = "AD";
        else initials = currentUser.getUsername().substring(0, Math.min(2, currentUser.getUsername().length())).toUpperCase();
    }
...
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <% } else if ("MO".equalsIgnoreCase(role)) { %>
            ...
            <a href="<%= ctx %>/mo/applicants" class="<%= uri.contains("applicants") ? "active" : "" %>">
        ...
        <% } else if ("ADMIN".equalsIgnoreCase(role)) { %>
            ...
            <a href="<%= ctx %>/admin/workload.jsp" class="<%= uri.contains("workload") ? "active" : "" %>">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/></svg>
                AI Workload
            </a>
...
<div class="main-area">
    ...
    <header class="topbar">
        ...
        <div class="topbar-right">
            ...
            <span class="topbar-notify" title="Notifications">
                <svg class="topbar-notify-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 0 1-3.46 0"/></svg>
                <span class="topbar-notify-badge">3</span>
            </span>
            <% } %>
            <a href="<%= ctx %>/logout" class="btn btn-ghost btn-sm">Logout</a>
            <div class="topbar-avatar <%= avatarClass %> topbar-avatar-role"><%= initials %></div>
        </div>
    </header>
