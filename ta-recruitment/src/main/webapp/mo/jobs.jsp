        ...
        <table class="data-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="${pageContext.request.contextPath}/mo/applicants.jsp?jobId=<%= job.getJobId() %>" style="color:var(--primary);font-weight:600;"><%= apps.size() %></a></td>
                    <td><span class="badge badge-<%= job.getStatus().toLowerCase() %>"><%= job.getStatus() %></span></td>
                    <td>
                        <a href="${pageContext.request.contextPath}/mo/applicants.jsp?jobId=<%= job.getJobId() %>" class="btn btn-primary btn-sm">View</a>
